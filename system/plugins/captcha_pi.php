...
function create_captcha($data = '', $img_path = '', $img_url = '', $font_path = '') {
    ...
    $img_url = $defaults['img_url'];
    $expiration = $defaults['expiration'];
    $word = $defaults['word'];
    $word_length = $defaults['word_length'];
    ...
    if ($word == '') {
        $pool = '23456789ABCDEFGHJKLMNPQRSTUVWXYZ'; //0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ
