...
{	
	...
	{
		/* settings */
		$font = $this->resourcepath.'fonts/calibri.ttf';/*define font*/
	...
	public function phpcaptcha($resourcePath='',$textColor,$backgroundColor,$imgWidth,$imgHeight,$noiceLines=0,$noiceDots=0,$noiceColor='#162453')
	{	
		/* Settings */
		$text=$this->random();
                $this->resourcepath = $resourcePath;
		$font = $this->resourcepath.'fonts/monofont.ttf';/* font */
		$textColor=$this->hexToRGB($textColor);	
